...
<button className="block focus:ring-4 focus:outline-none focus:ring-blue-300   text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 fixed top-2 left-0 md:left-2/4  bg-cyan-600 rounded text-black  hover:bg-zinc-600 hover:scale-125  hover:text-white font-bold" type="button" onClick={(ev)=>document.getElementById('defaultModal').classList.toggle('hidden')}
    ...
    <div className="relative w-full max-w-2xl max-h-full">
        ...
        <div className="relative bg-zinc-700 rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                onClick={(ev)=>document.getElementById('defaultModal').classList.toggle('hidden')}>
