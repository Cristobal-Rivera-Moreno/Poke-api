...
<button id="more-info-button" onClick={()=>{ document.getElementById('more-info').classList.toggle('hidden') }} className="group fixed left-3/4 top-2 bg-blue-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full">
  Más información
  <img className="inline-block group-hover:animate-ping" src="https://github.com/Cristobal-Rivera-Moreno/Poke-api/blob/main/src/assets/pokebola.png?raw=true" type="image/png+xml" width={20}></img><p className="text-xs">Image By Nikita Golubev</p>
</button>
